...
import { FacebookIcon, MessageCircle, TwitterIcon } from 'lucide-react-native';
...
const ButtonComponent = ({
  ...
  return (
    ...
    >
      <Icon as={IconName} fill="currentColor" color={color} px="$2" />
      <Button.Text fontWeight="$semibold">{buttonText}</Button.Text>
    </Button>
  );
};
    ...
    >
      ...
      <Box mt="$5">
        ...
        >
          ...
          >
            <Button.Text fontWeight="$semibold">Send</Button.Text>
          </Button>
        </VStack>
      </Box>
    </VStack>
